...
1. Download the dashboard `.json` files for Cyware Intel Exchange from the following [GitHub](https://github.com/cyware-labs/google-secops/tree/main/siem/Dashboards) repository.
...
Correlation rules scan events ingested into Google SecOps SIEM to generate detections and alerts based on specific conditions.  Integration provides 8 rules that you can modify or copy to get started. You can find the Cyware Intel Exchange correlation rules in the following [GitHub](https://github.com/cyware-labs/google-secops/tree/main/siem/Detection%20Rules) repository.

### Create a New Correlation Rule

1. From Google SecOps SIEM, navigate to **Detections > Rules & Detections**.
2. From the **Rules Editor** tab, click **New**.
3. In the rule editor, clear all the contents, and then copy and paste the code from the [GitHub](https://github.com/cyware-labs/google-secops/tree/main/siem/Detection%20Rules) repository.
