...
# from google3.third_party.chronicle.ingestion_scripts.cyware_threat_intelligence_exchange import main
...
class TestMain(unittest.TestCase):
    ...
    def test_main_cyware_exception_during_ingestion(
        ...
        mock_client = Mock()
        mock_client_class.return_value = mock_client
        mock_client.fetch_indicators_by_labels.side_effect = (
            CywareCTIXException("API error occurred")
        )
    ...
    @patch(f"{INGESTION_SCRIPTS_PATH}main.utils.cloud_logging")
    def test_main_permission_check_called_first(
        self, mock_log, mock_check_perms
    ):
